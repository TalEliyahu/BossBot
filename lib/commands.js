...
const defaultConfig = { "joinedMsg" : false, "pinnedMsg" : false, "arabicMsg" : false, "urlMsg" : false, "deleteCommands" : false, "helloMsg" : false }
...
class Commands {
   ...
   */
    ...
    *Available commands:*
    ...
    // To remove the /commands after the user have consumed it
    deleteCmdMessage(msg){
